...
import com.luxcloud.ExecuteCommandViaSSH;
import com.luxcloud.Find;
import com.luxcloud.GUI;
import com.luxcloud.deployService;
import com.luxcloud.ProgressWindow;
...
public class Engine implements ActionListener{
	...
	String[] histRemoveCommands={
			...
			"sudo rm -rf /var/log/phasorpoint-historian/", 
			"sudo rm -rf /var/phasorpoint-historian/"
	};
	...
	public void actionPerformed (ActionEvent e){
		...
		if (clickedButton.getText()=="Install PDC, AppServer, Historian"){
			...
			Thread startAllServices=new Thread(new waitFinishAppAndHistServicesDeploy(pdcInstall, appServerInstall, histServerInstall, parent.GetInternalPDCIP(), parent.GetInternalAppServerIP(), parent.GetInternalHistorianIP(), parent.getUserName(), parent.getSudoPassword(),progressWind));
